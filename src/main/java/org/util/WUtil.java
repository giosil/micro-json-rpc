...
class WUtil
{
  ...
  static {
    try {
      ...
      if(sCountry.equals("IT")) { // tipical italian client setting
        timeZone = TimeZone.getTimeZone("Europe/Rome");
      }
      else {
        String sTZ = timeZone.getID();
        if(sTZ.startsWith("Europe") || sTZ.startsWith("GMT+01") || sTZ.equalsIgnoreCase("Etc/GMT+1")) { // tipical italian server setting
  ...
  Integer toInteger(Object object, Integer oDefault)
  {
    ...
    if(object instanceof String) {
      ...
      try{
        Integer oResult = Integer.parseInt(sValue);
    ...
    return toInt(object, oDefault != null ? oDefault.intValue() : 0);
  }
...
//        sValue = sb.toString();
    ...
    return toDouble(object, oDefault != null ? oDefault.doubleValue() : 0.0d);
  }
  ...
  Long toLongObj(Object object, Long oDefault)
  {
    ...
    if(object instanceof String) {
      ...
      try{
        Long oResult = Long.parseLong(sValue);
        if(sValue.endsWith(oResult.toString())) {
          return oResult;
        }
        else {
    ...
    return toLong(object, oDefault != null ? oDefault.longValue() : 0l);
  }
  ...
  Number toNumber(Object object, int iDefault)
  {
    ...
    if(result == null) return iDefault;
    return result;
  }
  ...
  {
    Number result = toNumber(object, null);
    if(result == null) return dDefault;
    return result;
  }
  ...
  Boolean toBooleanObj(Object object, Boolean oDefault)
  {
    ...
    return toBoolean(object, oDefault != null ? oDefault.booleanValue() : false);
  }
